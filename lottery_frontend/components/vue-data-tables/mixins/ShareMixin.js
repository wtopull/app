      ...
      <div class='sc-table'>
        {
          ...
          ? (
            <div class='tool-bar row'>
              <div class='actions col' { ...{props: this.innerActionsDef.colProps} }>
                {
              ...
              </div>
              {
                this.checkboxShow
                  ? (
                    <div class='col filters' {...{ props: this.innerCheckboxFilterDef.colProps }}>
                      <checkbox-group
              ...
              }
              {
                this.searchShow
                  ? (
                    <div class='search col' { ...{props: this.innerSearchDef.colProps} }>
                      <el-input
