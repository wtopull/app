...
<style>
  * {
  ...
  .ball-main .ball-num.active, .ball-main .ball-txt.active {
    background: #00b5b1;
    border-color: #00b5b1;
    color: #fff;
  }
  ...
  .buySet-warp-left .ivu-btn-group:not(.ivu-btn-group-vertical)>.ivu-btn:first-child:not(:last-child), .buySet-warp-left .ivu-btn-group .ivu-btn:not(:first-child):not(:last-child), .buySet-warp-left .ivu-btn-group:not(.ivu-btn-group-vertical)>.ivu-btn:last-child:not(:first-child) {
    border-radius: 5px;
  }
  .lottery-content>.ivu-tabs {
    width: 100%;
  }
  .lottery-content .ivu-btn-group:not(.ivu-btn-group-vertical) .ivu-btn-primary+.ivu-btn, .ivu-btn-group:not(.ivu-btn-group-vertical) .ivu-btn-primary:last-child:not(:first-child) {
  ...
  .buySet-Btns .ivu-btn:first-child:hover, .buySet-Btns .ivu-btn:nth-child(2), .buySet-Btns .ivu-btn:nth-child(3) {
    color: #fff;
  }
  ...
  .buyCard .table .td, .buyCard .table .th {
    line-height: 40px;
    height: 40px;
    text-align: center;
    font-weight: normal;
  ...
  .buyCard .table .td:last-child, .buyCard .table .th:last-child {
    width: 8%
  }
